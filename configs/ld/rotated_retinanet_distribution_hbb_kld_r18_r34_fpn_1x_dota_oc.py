...
teacher_ckpt = 'r34-kld-2x.pth'
model = dict(
    type='KnowledgeDistillationRotatedSingleStageDetector',
    teacher_config='configs/kld/rotated_retinanet_distribution_hbb_kld_r34_fpn_2x_dota_oc.py',
    ...
    bbox_head=dict(
        ...
        loss_ld=dict(
            type='KnowledgeDistillationKLDivLoss', loss_weight=15, T=5),
        loss_kd=dict(
            type='KnowledgeDistillationKLDivLoss', loss_weight=15, T=5),
