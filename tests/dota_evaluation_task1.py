...
def main():
    ...
    detpath = r'/yourpath/Rotated-LD/work_dirs/ld_rretinanet_obb_r18_r34_fpn_1x_dota_xywha_v1/Task1_results/Task1_{:s}.txt'
    annopath = r'/yourpath/dataset/DOTAv1/label/{:s}.txt' # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'/yourpath/dataset/DOTAv1/val_set.txt'
    ...
    for iii in range(10):
        ...
        print('AP',int(100*(0.5+iii*0.05)), ': ', map)
        #classaps = 100*np.array(classaps)
        #print('classaps: ', classaps)
        total_map = map + total_map
    print('AP: ', total_map/10)
